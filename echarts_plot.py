...
def kline_pro(
    ...
    dz_inside = opts.DataZoomOpts(
        ...
        "inside",
        xaxis_index=[0, 1, 2],
        range_start=100 - (144 / len(kline) * 100),
        range_end=100,
    )
    dz_slider = opts.DataZoomOpts(
        True,
    ...
    ma12 = SMA(close, timeperiod=12)
    ma36 = SMA(close, timeperiod=36)
    ma366 = SMA(close, timeperiod=366)
    ...
    ma_keys = {"MA12": ma12, "MA36": ma36, "MA366": ma366}
    ...
    if bzs:
        for zs in bzs:
            ...
            chart_k = chart_k.overlap(chart_bi_zs)
